****************************************************************
               Welcome to SQLAPI++ Library 5.1.1
****************************************************************
...
-- SQLServer (ODBC): Omit using LONG field size becasue of possible bug whe UTF-8 locale used at the client side (thanks Santiago Núñez).
